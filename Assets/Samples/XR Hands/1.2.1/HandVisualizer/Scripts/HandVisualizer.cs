...
namespace UnityEngine.XR.Hands.Samples.VisualizerSample
{
    public class HandVisualizer : MonoBehaviour
    {
        ...
        public float xAxisPositionR;
        public float xAxisPositionL;
        void OnUpdatedHands(XRHandSubsystem subsystem, XRHandSubsystem.UpdateSuccessFlags updateSuccessFlags, XRHandSubsystem.UpdateType updateType)
        {
            ...
            {
                var wristR = subsystem.rightHand.GetJoint(XRHandJointID.Wrist);
                wristR.TryGetPose(out var wristPoseR);
                Vector3 wristPositionR = wristPoseR.position;
                //Debug.Log("rigthHand pos: " + wristPositionR);
                xAxisPositionR = wristPositionR.x;
                //Debug.Log("x axis position R: " + xAxisPositionR);

                var wristL = subsystem.leftHand.GetJoint(XRHandJointID.Wrist);
                wristL.TryGetPose(out var wristPoseL);
                Vector3 wristPositionL = wristPoseL.position;
                //Debug.Log("leftHand pos: " + wristPositionL);
                xAxisPositionL = (-wristPositionL.x);
                //Debug.Log("x axis position L: " + xAxisPositionL);
            }
